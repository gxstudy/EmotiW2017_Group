...
model_weights ="group_human_train_val_inception_v2_iter_3200.caffemodel"
...
pose_dir = '../data/group_Skeleton_face_pose_valid' 
...
face_pose_inception_preds = np.zeros((lcount,3))
...
for iname in sorted(os.listdir(image_dir)):
    ...
    face_pose_inception_preds[num_count]=prediction[0]
    print face_pose_inception_preds[num_count] 
    num_count += 1  

np.save('face_pose_inception_preds.npy',face_pose_inception_preds)
